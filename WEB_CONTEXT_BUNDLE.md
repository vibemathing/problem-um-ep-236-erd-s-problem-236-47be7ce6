...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-236-erd-s-problem-236-47be7ce6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-236"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-236-erd-s-problem-236-47be7ce6-v1",
      "problem_contract_sha256": "e46d02239e3a48653ce11e681785e679ab57e748a16c8ca02be06c9eb1bc51ba",
      "problem_id": "problem:um-ep-236-erd-s-problem-236-47be7ce6",
      "route_id": "route:um-ep-236-erd-s-problem-236-47be7ce6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-236-erd-s-problem-236-47be7ce6-source-fidelity-01",
      "graph_id": "graph:um-ep-236-erd-s-problem-236-47be7ce6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-236-erd-s-problem-236-47be7ce6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-236-erd-s-problem-236-47be7ce6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(n)$ count the number of solutions to $n=p+2^k$ for prime $p$ and $k\\geq 0$. Is it true that $f(n)=o(\\log n)$?"
          },
          "statement_sha256": "2046216014d55ffad9cc1b314561526106487e25e980d520ff5e9ae1d7aba887"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-236-erd-s-problem-236-47be7ce6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-236-erd-s-problem-236-47be7ce6-root",
      "route_id": "route:um-ep-236-erd-s-problem-236-47be7ce6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-236-1ab91d14523b",
        "url": "https://www.unsolvedmath.com/problems/EP-236"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
